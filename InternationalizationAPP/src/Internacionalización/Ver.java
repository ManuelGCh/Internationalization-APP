...
import static Internacionalización.Ver.listadatos;
...
public class Ver extends javax.swing.JFrame {
     ...
     */
    public Ver(ArrayList <ArrayList<String>> cad, int numeroIdiomas, int idElegido, String [] lista) {
        cadena = cad;
    ...
    private void initComponents() {
        ...
        setTitle(cadena.get(idiomaElegido).get(5));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Ver(cadena, numeroId, idiomaElegido, listaIdiomas).setVisible(true);
            }
        });
    }
